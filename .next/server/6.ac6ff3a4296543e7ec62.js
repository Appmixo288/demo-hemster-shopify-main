...
exports.modules = {
  ...
  /***/ uDpD: /***/ function (
    ...
    function AddProducts_ownKeys(object, enumerableOnly) {
      var keys = Object.keys(object);
      if (Object.getOwnPropertySymbols) {
        var symbols = Object.getOwnPropertySymbols(object);
        if (enumerableOnly)
    ...
    function AddProducts_objectSpread(target) {
      for (var i = 1; i < arguments.length; i++) {
        var source = arguments[i] != null ? arguments[i] : {};
        if (i % 2) {
          AddProducts_ownKeys(Object(source), true).forEach(function (key) {
            AddProducts_defineProperty(target, key, source[key]);
          });
        } else if (Object.getOwnPropertyDescriptors) {
          Object.defineProperties(
            target,
          ...
          AddProducts_ownKeys(Object(source)).forEach(function (key) {
            Object.defineProperty(
              target,
              key,
              Object.getOwnPropertyDescriptor(source, key)
    ...
    function AddProducts_defineProperty(obj, key, value) {
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function AddProducts(props) {
      ...
      const { 0: priceValue, 1: setPriceValue } = Object(
        external_react_["useState"]
      )("");
      const { 0: checked, 1: setChecked } = Object(external_react_["useState"])(
        false
      );
      const handleChangebyPrice = Object(external_react_["useCallback"])(
        (newChecked) => setChecked(newChecked),
        []
      );
      const handleTextFieldChange = Object(external_react_["useCallback"])(
      ...
      const { 0: isLoadingType, 1: setIsLoadingType } = Object(
        external_react_["useState"]
      )(false); //toast

      const { 0: active, 1: setActive } = Object(external_react_["useState"])({
        isOpen: false,
        msg: "",
        isErr: false,
      });
      const toastMarkup = active.isOpen
        ? /*#__PURE__*/ Object(jsx_runtime_["jsx"])(polaris_["Toast"], {
            content: active.msg,
            onDismiss: () =>
              setActive({
                isOpen: false,
      ...
      const { 0: tags, 1: setTags } = Object(external_react_["useState"])([]);
      const { 0: types, 1: setTypes } = Object(external_react_["useState"])([]);
      ...
      const { 0: popoverActiveTag, 1: setPopoverActiveTag } = Object(
        external_react_["useState"]
      )(false);
      const { 0: selectedTag, 1: setSelectedTag } = Object(
        external_react_["useState"]
      )([]);
      const togglePopoverActiveTag = Object(external_react_["useCallback"])(
        () => setPopoverActiveTag((popoverActiveTag) => !popoverActiveTag),
        []
      );

      const activatorTag = /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
        polaris_["Button"],
        {
      ...
      const { 0: popoverActiveType, 1: setPopoverActiveType } = Object(
        external_react_["useState"]
      )(false);
      const { 0: selectedType, 1: setSelectedType } = Object(
        external_react_["useState"]
      )([]);
      const togglePopoverActiveType = Object(external_react_["useCallback"])(
        () => setPopoverActiveType((popoverActiveType) => !popoverActiveType),
        []
      );

      const activatorType = /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
        polaris_["Button"],
        {
      ...
      const { 0: isOpenProduct, 1: setIsOpenProduct } = Object(
        external_react_["useState"]
      )(false);
      const { 0: selectedProduct, 1: setSelectedProduct } = Object(
        external_react_["useState"]
      )([]);
      ...
      function removeSelectedProduct(index) {
        if (index > -1) {
          ...
          setSelectedProduct(
            AddProducts_objectSpread(
              AddProducts_objectSpread({}, selectedProduct),
              {},
              {
      ...
      const { 0: isOpenColl, 1: setIsOpenColl } = Object(
        external_react_["useState"]
      )(false);
      const { 0: selectedColl, 1: setSelectedColl } = Object(
        external_react_["useState"]
      )([]);
      ...
      function removeSelectedColl(index) {
        if (index > -1) {
          ...
          setSelectedColl(
            AddProducts_objectSpread(
              AddProducts_objectSpread({}, selectedColl),
              {},
              {
                selection: updatedRes,
              }
            ...
            /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(polaris_["Layout"], {
              children: [
                /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
                  polaris_["Layout"].Section,
                  {
                    oneHalf: true,
                    children: /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(
                      polaris_["Card"],
                      {
                        sectioned: true,
                        children: [
                          ...
                          isOpenProduct &&
                            /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
                              app_bridge_react_["ResourcePicker"],
                              {
    ...
    function UpsellIndex(props) {
      ...
      const page_info = Object(external_react_redux_["useSelector"])(
        (state) => state.allReducer.page_info
      );
    ...
    function Product(props) {
      ...
      const { 0: isEdit, 1: setIsEdit } = Object(external_react_["useState"])(
        false
      ); //toast
      ...
      const toastMarkup = active.isOpen
        ...
        : null;
      const { 0: type, 1: setType } = Object(external_react_["useState"])(
        "option1"
      );
      const handleChangeType = Object(external_react_["useCallback"])(
        (_checked, newValue) => setType(newValue),
        []
      );
      const { 0: fontSize, 1: setFontSize } = Object(
        external_react_["useState"]
      )("16");
      const { 0: linkSize, 1: setLinkSize } = Object(
        external_react_["useState"]
      )("16");
      const {
      ...
      const { 0: popoverActiveBGColor, 1: setPopoverActiveBGColor } = Object(
        external_react_["useState"]
      )(false);
      const togglePopoverActiveFontColor = Object(
        external_react_["useCallback"]
      )(
        () =>
          setPopoverActiveFontColor(
            (popoverActiveFontColor) => !popoverActiveFontColor
          ),
        []
      );
      const togglePopoverActiveLinkColor = Object(
        external_react_["useCallback"]
      )(
        () =>
          setPopoverActiveLinkColor(
            (popoverActiveLinkColor) => !popoverActiveLinkColor
          ),
        []
      );
      const togglePopoverActiveCheckBoxColor = Object(
        external_react_["useCallback"]
      )(
        () =>
          setPopoverActiveBGColor(
            (popoverActiveBGColor) => !popoverActiveBGColor
          ),
        []
      );
      const { 0: FontColor, 1: setFontColor } = Object(
        external_react_["useState"]
      )({
        hue: 0.0,
        brightness: 0.0,
      ...
      const { 0: LinkColor, 1: setLinkColor } = Object(
        external_react_["useState"]
      )({
        hue: 0.0,
        brightness: 0.0,
      ...
      const { 0: BGColor, 1: setBGColor } = Object(external_react_["useState"])(
        {
          hue: 0.0,
          brightness: 0.0,
          saturation: 0.0,
      ...
      const rgbaColorBGColor = Object(polaris_["rgbString"])(
        Object(polaris_["hsbToRgb"])(BGColor)
      );
      const rgbaColorFontColor = Object(polaris_["rgbString"])(
        Object(polaris_["hsbToRgb"])(FontColor)
      );
      const rgbaColorLinkColor = Object(polaris_["rgbString"])(
        Object(polaris_["hsbToRgb"])(LinkColor)
      );
      const { 0: selected, 1: setSelected } = Object(
        external_react_["useState"]
      )("");
      const handleSelectChange = Object(external_react_["useCallback"])(
      ...
      const { 0: FontColorHexColor, 1: setFontColorHexColor } = Object(
        external_react_["useState"]
      )(Object(polaris_["hsbToHex"])(FontColor));
      const { 0: LinkColorHexColor, 1: setLinkColorHexColor } = Object(
        external_react_["useState"]
      )(Object(polaris_["hsbToHex"])(LinkColor));
      const { 0: checkBoxColorHexColor, 1: setcheckBoxColorHexColor } = Object(
        external_react_["useState"]
      )(Object(polaris_["hsbToHex"])(BGColor));
      ...
      const activatorFontColor = /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(
        "div",
        {
          children: [
      ...
      const activatorLinkColor = /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(
        "div",
        {
          children: [
            /*#__PURE__*/ Object(jsx_runtime_["jsx"])("label", {
      ...
      const activatorBGColor = /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(
        "div",
        {
          children: [
            /*#__PURE__*/ Object(jsx_runtime_["jsx"])("label", {
          ...
          .then((response) => {
            ...
            if (
              ...
              if (response.data.data) {
                ...
                checkboxColor &&
                  handlecheckBoxColorHexColorChange(checkboxColor);
      ...
      const settingOption1 = /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
        polaris_["Card"],
        {
          sectioned: true,
          children: /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
                        ...
                        children: [
                          ...
                          /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(
                            polaris_["Popover"],
                            {
                              ...
                              children: [
                                /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
                                  polaris_["Popover"].Section,
                                  {
                                    children: /*#__PURE__*/ Object(
                                      jsx_runtime_["jsx"]
                                    )(polaris_["ColorPicker"], {
      ...
      return /*#__PURE__*/ Object(jsx_runtime_["jsxs"])("div", {
        children: [
          ...
          isLoading &&
            /*#__PURE__*/ Object(jsx_runtime_["jsx"])(polaris_["Loading"], {}),
          toastMarkup,
        ],
      });
    }
    ...
    function ThankYou(props) {
      ...
      const { 0: redirectURL, 1: setRedirectURL } = Object(
        external_react_["useState"]
      )("");
      const { 0: HeadingfontSize, 1: setHeadingFontSize } = Object(
        external_react_["useState"]
      )("15");
      const { 0: ContentfontSize, 1: setContentFontSize } = Object(
        external_react_["useState"]
      )("15");
      const {
      ...
      const togglePopoverActiveHeadingFontColor = Object(
        external_react_["useCallback"]
      )(
        () =>
          setPopoverActiveHeadingFontColor(
            (popoverActiveHeadingFontColor) => !popoverActiveHeadingFontColor
          ),
        []
      );
      const togglePopoverActiveButtonBGColor = Object(
        external_react_["useCallback"]
      )(
        () =>
          setPopoverActiveButtonBGColor(
            (popoverActiveButtonBGColor) => !popoverActiveButtonBGColor
          ),
        []
      );
      const togglePopoverActiveButtonFontColor = Object(
        external_react_["useCallback"]
      )(
        () =>
          setPopoverActiveButtonFontColor(
            (popoverActiveButtonFontColor) => !popoverActiveButtonFontColor
          ),
        []
      );
      const togglePopoverActiveContentColor = Object(
        external_react_["useCallback"]
      )(
        () =>
          setPopoverActiveContentColor(
            (popoverActiveContentColor) => !popoverActiveContentColor
          ),
        []
      );
      const togglePopoverActiveBGColor = Object(external_react_["useCallback"])(
        () =>
          setPopoverActiveBGColor(
            (popoverActiveBGColor) => !popoverActiveBGColor
          ),
      ...
      const { 0: HeadingFontColor, 1: setHeadingFontColor } = Object(
        external_react_["useState"]
      )({
        hue: 0.0,
        brightness: 0.0,
      ...
      const { 0: ContentColor, 1: setContentColor } = Object(
        external_react_["useState"]
      )({
        hue: 0.0,
        brightness: 0.0,
      ...
      const { 0: ButtonBGColor, 1: setButtonBGColor } = Object(
        external_react_["useState"]
      )({
        hue: 0.0,
        brightness: 0.0,
      ...
      const { 0: ButtonFontColor, 1: setButtonFontColor } = Object(
        external_react_["useState"]
      )({
        hue: 0.0,
        brightness: 0.0,
      ...
      const rgbaColorButtonFontColor = Object(polaris_["rgbString"])(
        Object(polaris_["hsbToRgb"])(ButtonFontColor)
      );
      const rgbaColorButtonBGColor = Object(polaris_["rgbString"])(
        Object(polaris_["hsbToRgb"])(ButtonBGColor)
      );
      const rgbaColorFontColor = Object(polaris_["rgbString"])(
        Object(polaris_["hsbToRgb"])(HeadingFontColor)
      );
      const rgbaColorContentColor = Object(polaris_["rgbString"])(
        Object(polaris_["hsbToRgb"])(ContentColor)
      );
      const rgbaColorBGColor = Object(polaris_["rgbString"])(
        Object(polaris_["hsbToRgb"])(BGColor)
      );
      ...
      const {
        ...
        Object(polaris_["hsbToHex"])(HeadingFontColor)
      );
      const { 0: ButtonBGColorHexColor, 1: setButtonBGColorHexColor } = Object(
        external_react_["useState"]
      )(Object(polaris_["hsbToHex"])(ButtonBGColor));
      const {
        0: ButtonFontColorHexColor,
        1: setButtonFontColorHexColor,
      } = Object(external_react_["useState"])(
        Object(polaris_["hsbToHex"])(ButtonFontColor)
      );
      const { 0: ContentColorHexColor, 1: setContentColorHexColor } = Object(
        external_react_["useState"]
      )(Object(polaris_["hsbToHex"])(ContentColor));
      const { 0: BGColorHexColor, 1: setBGColorHexColor } = Object(
        external_react_["useState"]
      )(Object(polaris_["hsbToHex"])(BGColor));
      ...
      const activatorHeadingFontColor = /*#__PURE__*/ Object(
        jsx_runtime_["jsxs"]
      )("div", {
        children: [
          /*#__PURE__*/ Object(jsx_runtime_["jsx"])("label", {
      ...
      const activatorContentColor = /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(
        "div",
        {
          children: [
            /*#__PURE__*/ Object(jsx_runtime_["jsx"])("label", {
      ...
      const activatorButtonFontColor = /*#__PURE__*/ Object(
        jsx_runtime_["jsxs"]
      )("div", {
        children: [
          /*#__PURE__*/ Object(jsx_runtime_["jsx"])("label", {
      ...
      const activatorButtonBGColor = /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(
        "div",
        {
          children: [
            /*#__PURE__*/ Object(jsx_runtime_["jsx"])("label", {
    ...
    function CartPopup(props) {
      const { 0: isLoading, 1: setIsLoading } = Object(
        external_react_["useState"]
      )(false); //Button enable/disable-------------------------------------

      const { 0: isFirstButtonActive, 1: setIsFirstButtonActive } = Object(
        external_react_["useState"]
      )(false);
      const handleFirstButtonClick = Object(
        external_react_["useCallback"]
      )(() => {
        if (isFirstButtonActive) return;
        setIsFirstButtonActive(true);
      }, [isFirstButtonActive]);
      const handleSecondButtonClick = Object(
        external_react_["useCallback"]
      )(() => {
        if (!isFirstButtonActive) return;
      ...
      const { 0: TitlefontSize, 1: setTitleFontSize } = Object(
        external_react_["useState"]
      )("15");
      const {
        0: popoverActiveHeadingFontColor,
      ...
      const togglePopoverActiveTitleColor = Object(
        external_react_["useCallback"]
      )(
        () =>
          setPopoverActiveTitleColor(
            (popoverActiveTitleColor) => !popoverActiveTitleColor
          ),
        []
      );
      const { 0: HeadingFontColor, 1: setHeadingFontColor } = Object(
      ...
      const { 0: TitleColor, 1: setTitleColor } = Object(
        external_react_["useState"]
      )({
        hue: 0.0,
        brightness: 0.0,
      ...
      const rgbaColorTitleColor = Object(polaris_["rgbString"])(
        Object(polaris_["hsbToRgb"])(TitleColor)
      );
      ...
      const { 0: TitleColorHexColor, 1: setTitleColorHexColor } = Object(
        external_react_["useState"]
      )(Object(polaris_["hsbToHex"])(TitleColor));
      ...
      const activatorTitleColor = /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(
        "div",
        {
          children: [
            /*#__PURE__*/ Object(jsx_runtime_["jsx"])("label", {
        ...
        getSettingCartPopup()
          .then((response) => {
            ...
            if (
              ...
              if (response.data.data) {
                const { isEnable } = response.data.data; // const { headingFontColor, headingFontSize, titleFontColor, titleFontSize, contentFontColor, contentFontSize, buttonFontColor, buttonBackgroundColor, isEnable } = response.data.data;
...
<div class="grid">
  ...
  <div class="grid__item-details">
    ...
    function Announcement(props) {
      ...
      const { 0: popoverActive, 1: setPopoverActive } = Object(
        external_react_["useState"]
      )(false);
      console.log(selected);
      const togglePopoverActive = Object(external_react_["useCallback"])(
        () => setPopoverActive((popoverActive) => !popoverActive),
        []
      );

      const activator = /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
        polaris_["Button"],
        {
...
<div class="container-acc" >
  ...
  <div class="acc-text-image">
    ...
    function Settings(props) {
      ...
      const { 0: isLoadingApp, 1: setIsLoadingApp } = Object(
        external_react_["useState"]
      )(false);
      ...
      return /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(polaris_["Page"], {
        title: "Settings",
        children: [
          /*#__PURE__*/ Object(jsx_runtime_["jsx"])(polaris_["SettingToggle"], {
            action: {
            ...
            children: /*#__PURE__*/ Object(jsx_runtime_["jsxs"])(
              polaris_["Tabs"],
              {
                ...
                children: [
                  ...
                  selected === 1 &&
                    /*#__PURE__*/ Object(jsx_runtime_["jsx"])(Thankyou, {}),
                  selected === 2 &&
                    /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
                      Settings_CartPopup,
                      {}
                  ...
                  selected === 3 &&
                    /*#__PURE__*/ Object(jsx_runtime_["jsx"])(Collection, {}),
                  selected === 4 &&
                    /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
                      Settings_AccountDetails,
                      {}
                    ),
                  selected === 5 &&
                    /*#__PURE__*/ Object(jsx_runtime_["jsx"])(
                      Settings_Announcement,
                      {}
                    ),
                ],
              }
    ...
    var external_jquery_default = /*#__PURE__*/ __webpack_require__.n(
      external_jquery_
    );
    ...
    function MainPage() {
      ...
      const { 0: isErr, 1: setIsErr } = Object(external_react_["useState"])(
        false
      );
      Object(external_react_["useEffect"])(() => {
    ...
    /* harmony default export */ var Component_MainPage = (__webpack_exports__[
      "default"
    ] = MainPage);
